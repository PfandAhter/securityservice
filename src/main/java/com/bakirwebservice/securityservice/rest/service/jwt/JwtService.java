...
import static com.bakirwebservice.securityservice.constants.PropertyConstants.JWT_CRYPTO_SECRET;
import static com.bakirwebservice.securityservice.constants.PropertyConstants.JWT_SECRET;
...
public class JwtService {
    ...
    @Value(JWT_CRYPTO_SECRET)
    private String jwtCryptoSecret;
    ...
    public String generateToken(Map<String, Object> extraClaims, UserDetails userDetails) {
        ...
        try {
            return EncryptionUtil.encrypt(jwt, jwtCryptoSecret);
        } catch (Exception e) {
    ...
    public String decryptJwt(String token) {
        try {
            return EncryptionUtil.decrypt(token, jwtCryptoSecret);
        } catch (Exception e) {
